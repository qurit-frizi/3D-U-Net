...
def main(args):
    ...
    # datasets:
    train_set = dataset.PETCTDataset(train_paths, transforms=train_transforms)
    val_set = dataset.PETCTDataset(val_paths, transforms=val_transforms)
